...
<section class="orders">
   ...
   <?php
      $select_orders = $conn->prepare("SELECT * FROM `orders` WHERE cust_ID = ? ORDER BY orderdate DESC");
   ...
   <div class="box" <?php if ($fetch_order['status'] == 'canceled') { echo 'style="border:.2rem solid red"'; } ?>>
      <a href="view_order.php?get_id=<?= $fetch_order['orderID']; ?>">
         <p class="date"><i class="fa fa-calendar"></i><span><?= $fetch_order['orderdate']; ?></span></p>
